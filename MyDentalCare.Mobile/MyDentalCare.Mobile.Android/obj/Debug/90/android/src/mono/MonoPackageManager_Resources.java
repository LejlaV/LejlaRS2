...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "MyDentalCare.Mobile.Android.dll" comes first in this list. */
		"MyDentalCare.Mobile.Android.dll",
